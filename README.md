Per eseguire il codice appbackend.py basterà solamente lanciare il codice con 'python AppBackend.py' e, con l'utilizzo per esempio di Postman, testare le varie funzionalità.
